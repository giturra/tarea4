...
class PrimeHash(BaseHash):
    def __init__(self, size=10, p=2, hash_func=None, update_size=False):
        super().__init__(size=size, hash_func=hash_func, hash_type='prime')
        self.p = p
        self.update_size = update_size

    def insert(self, element, return_comp):
        counter = 0
